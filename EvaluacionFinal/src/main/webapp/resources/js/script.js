...
$(document).ready(function(){
    ...
    $('#admForm').validate({
        ...
        messages: {
            ...
            txtadmnombres: "Este es un campo obligatorio.",
            txtadmapellidos: "Este es un campo obligatorio.",         
            txtadmafp: "Este es un campo obligatorio.",
            txtadmsistemasalud: "Este es un campo obligatorio.",
            txtusuariorun: {
                required: "Este campo es obligatorio.",
                rut: "El numero ingresado no corresponde a un rut real",
            },
